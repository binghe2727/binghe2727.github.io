...
- My foucs of research area is Machine Learning and Natural Language Processing (NLP). My research topic is to design advanced NLP methods to characterize, detect, and mitigate incorrect and harmful contents generated by: (1) humans, e.g., misinformation, fake news, hate speech, and fraud: (2) machines, e.g., hallucinations in/alignment of/evaluation of Large Language Models (LLMs). 


- I am looking for full-time research scientist/data scientist/applied scientist positions. Please contact me if you are hiring or know good positions!
